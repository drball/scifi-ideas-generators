...
var they = [
    ...
    "are obsessed with puzzles and games of mental arithmetic, which are considered to be works of art. Their entire society has been 'gamified'",
    ...
    "don't believe in monogamy, and collect multiple partners",
    "communicate using sign-language",
    "communicate using semaphor",
    "never excrete",
    "excrete a dangerous acid",
...
var summary = [
    ...
    "invented spaceflight a thousand years before Humans",
...
function randomQuirk(){
    ...
    var quirk = [
        ...
        "They wear helmets so nobody has ever seen what their faces look like.",
        "They are are extremely skittish, and will hide in crevices to avoid being found.",
        "They migrate once a year to breed.",
        ...
        "They're able to jump 500 times their own height.",
        ...
        "Their homeworld is located near a black hole.",
        ...
        "Their race is divided into hundreds of different cultures.",
        ...
        "Their females kill the males after mating.",
        "In their society, only the males are allowed to speak.",
        "Only the females are allowed out at night.",
